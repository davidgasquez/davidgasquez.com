...
- The app loads arbitrary rounds and lets users vote locally on the best allocation.
- The client produces a signed output that is easy to copy and paste anywhere public.
- **Collection and aggregation are separate steps**: responses can move through any channel, and anyone can later derive or verify the rankings/scores.
